...
public struct Rect
{
    ...
    public static Rect operator - (Rect a, Vector2<int> b) { return SubRectVector2(a, b); }
    public static Rect operator - (Rect a, Vector2<float> b) { return SubRectVector2(a, b); }
    public static Rect operator - (Rect a, Vector2<double> b) { return SubRectVector2(a, b); }
